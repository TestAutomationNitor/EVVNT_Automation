...

{
	...
	{
		Zip.zipDir(System.getProperty("user.dir") + "\\GalenReport\\galen-html-reports",
		...
		SendMail.sendMail(Constants.EmailId_From, Constants.Password, host, "587", "true", "true", true,
